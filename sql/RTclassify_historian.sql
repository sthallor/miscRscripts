/******************************************************************/
/* SQL QUERY from Mark Kuziej February 21, 2017 */
/* Designed to access historian database returning most recent 5 minutes for columns: */

/* historian_hole_depth */
/* historian_bit_depth */
/* historian_blockheight */
/* historian_hookload */
...
select *
      ,'kNm' as Torque_UOM
	  ,'meters' as HoleDepth_UOM
	  ,'meters' as BitDepth_UOM
	  ,'RPM' as RPM_UOM
	  ,'daN' as Hookload_UOM
	  ,'m/hr' as OnBottomROP_UOM
	  ,'daN' as WeightOnBit_UOM
	  ,'feet' as BlockHeight_UOM
	  ,'psi' as PumpPressure_UOM
	  ,'SPM' as MudPumpStrokes_UOM
 from #results order by 1
